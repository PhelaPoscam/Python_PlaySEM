...
class TestIsolatedRouting:
    ...
    @pytest.mark.asyncio
    async def test_isolated_websocket_only_falls_back_to_websocket(self, server):
...
class TestDirectRouting:
    ...
    @pytest.mark.asyncio
    async def test_direct_device_multiple_protocols_prefers_websocket(self, server):
